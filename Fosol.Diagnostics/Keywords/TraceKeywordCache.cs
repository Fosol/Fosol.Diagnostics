...
namespace Fosol.Diagnostics.Keywords
{
    ...
    {
        #region Variables
        private static readonly Dictionary<string, TraceKeyword> _Cache = new Dictionary<string, TraceKeyword>();
        ...
        public int Add(string cacheKey, TraceKeyword keyword)
        {
        ...
        public TraceKeyword Get(string cacheKey)
        {
