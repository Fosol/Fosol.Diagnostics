...
namespace Fosol.Diagnostics
{
        ...
        : Attribute
    {
        ...
        {
            ApplyAttributes(obj, null); //obj.Attributes);
        }
            ...
            where T : class
        {
            ...
            var fields = (
                ...
                where f.GetCustomAttributes(typeof(TracePropertyAttribute)).FirstOrDefault() != null
                select new
                {
                    Field = f,
                    Attr = f.GetCustomAttributes(typeof(TracePropertyAttribute)).FirstOrDefault() as TracePropertyAttribute,
            ...
            foreach (var field in fields)
            {
                ...
                {
                    throw new System.Configuration.ConfigurationErrorsException(string.Format(Resources.Strings.Configuration_Exception_Attribute_Required, field.Attr.Name));
                }
            }
            ...
            var properties = (
                ...
                where p.CanWrite
                    && p.GetCustomAttributes(typeof(TracePropertyAttribute)).FirstOrDefault() != null
                select new
                {
                    Property = p,
                    Attr = p.GetCustomAttributes(typeof(TracePropertyAttribute)).FirstOrDefault() as TracePropertyAttribute,
            ...
            foreach (var prop in properties)
            {
                ...
                {
                    throw new System.Configuration.ConfigurationErrorsException(string.Format(Resources.Strings.Configuration_Exception_Attribute_Required, prop.Attr.Name));
                }
            }
        }
        #endregion
